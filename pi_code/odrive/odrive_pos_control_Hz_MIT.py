...
SETPOINT_1_TIME = 0.5 # Seconds spent in setpoint 1.
SETPOINT_2_TIME = 0.5 # Seconds spent in setpoint 2.
STEP_SIZE = 0.1 # Step function step size (turns).

# --- Loop Timing ---
RECORDING_RATE_HZ = 1000 # Rate at which we record data.
CONTROL_LOOP_RATE_HZ =10 # Control loop frequency.
...
# --- Plotting Setup ---
max_data_points = int((SETPOINT_1_TIME + SETPOINT_2_TIME) * RECORDING_RATE_HZ)
